...
namespace Ibsys2.Service {
    public static class EnglishTranslation {
        ...
        private static void Translate() {
            ...
            _translate.Add("PLAN1", "Kapazitätsplan Capacity planning workplace 1");
            _translate.Add("PLAN2", "Kapazitätsplan Capacity planning workplace 2");
            _translate.Add("PLAN3", "Kapazitätsplan Capacity planning workplace 3");
            _translate.Add("PLAN4", "Kapazitätsplan Capacity planning workplace 4");
            _translate.Add("PLAN6", "Kapazitätsplan Capacity planning workplace 6");
            _translate.Add("PLAN7", "Kapazitätsplan Capacity planning workplace 7");
            _translate.Add("PLAN8", "Kapazitätsplan Capacity planning workplace 8");
            _translate.Add("PLAN9", "Kapazitätsplan Capacity planning workplace 9");
            _translate.Add("PLAN10", "Kapazitätsplan Capacity planning workplace 10");
            _translate.Add("PLAN11", "Kapazitätsplan Capacity planning workplace 11");
            _translate.Add("PLAN12", "Kapazitätsplan Capacity planning workplace 12");
            _translate.Add("PLAN13", "Kapazitätsplan Capacity planning workplace 13");
            _translate.Add("PLAN14", "Kapazitätsplan Capacity planning workplace 14");
            _translate.Add("PLAN15", "Kapazitätsplan Capacity planning workplace 15");
